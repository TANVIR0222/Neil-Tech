...
const RestockedItems = () => {
  return (
    <View style={tw`flex-1  gap-5  flex-col justify-between pb-4`}>
      ...
      <MainButton title='Shop in Nails By Codie' onPress={() => router.push('/stock-reorder-list/nails-by-codie-shop')} />

    </View>
  )
}

export default RestockedItems